import { $ as pingServer, D as Deferred, E as Component, F as deepEqual, G as isCloudflareWorker, H as getUA, I as extractQuerystring, K as isEmpty, L as getDefaultEmulatorHost, O as ErrorFactory, P as createSubscribe, T as Logger, U as isBrowserExtension, V as getModularInstance, W as isCloudWorkstation, X as isReactNative, Y as isMobileCordova, c as _getProvider, et as querystring, f as _registerComponent, g as getApp, j as base64Decode, k as FirebaseError, n as SDK_VERSION, q as isIE, tt as querystringDecode, u as _isFirebaseServerApp, w as LogLevel, x as registerVersion, z as getExperimentalSetting } from "./index.esm-CLNMq8gw.js";
//#region node_modules/@firebase/auth/dist/esm/index-DGK4UgBf.js
/**
* @license
...
async function signInAnonymously(auth) {
	...
	if (authInternal.currentUser?.isAnonymous) return new UserCredentialImpl({
...
function isSignInWithEmailLink(auth, emailLink) {
	return ActionCodeURL.parseLink(emailLink)?.operation === "EMAIL_SIGNIN";
}
/**
...
function getMultiFactorResolver(auth, error) {
	...
	_assert(errorInternal.customData._serverResponse?.mfaPendingCredential, authModular, "argument-error");
	...
	*/
	...
	async _poll() {
		...
		try {
			...
			if (!this.isHiding) _logWarn(`Firebase Auth cross-tab polling failed with error: ${e}`);
			return [];
		}
	}
...
* limitations under the License.
*/
var EVENT_DUPLICATION_CACHE_DURATION_MS = 6e5;
