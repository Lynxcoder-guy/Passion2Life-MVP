...
//#endregion
export { pingServer as $, areCookiesEnabled as A, getGlobal as B, openDB as C, Deferred as D, Component as E, deepEqual as F, isCloudflareWorker as G, getUA as H, extractQuerystring as I, isIndexedDBAvailable as J, isEmpty as K, getDefaultEmulatorHost as L, calculateBackoffMillis as M, createMockUserToken as N, ErrorFactory as O, createSubscribe as P, isSafariOrWebkit as Q, getDefaultEmulatorHostnameAndPort as R, setLogLevel as S, Logger as T, isBrowserExtension as U, getModularInstance as V, isCloudWorkstation as W, isReactNative as X, isMobileCordova as Y, isSafari as Z, getApps as _, _apps as a, onLog as b, _getProvider as c, _isFirebaseServerAppSettings as d, querystring as et, _registerComponent as f, getApp as g, deleteApp as h, _addOrOverwriteComponent as i, base64Decode as j, FirebaseError as k, _isFirebaseApp as l, _serverApps as m, SDK_VERSION as n, validateIndexedDBOpenable as nt, _clearComponents as o, _removeServiceInstance as p, isIE as q, _addComponent as r, _components as s, DEFAULT_ENTRY_NAME as t, querystringDecode as tt, _isFirebaseServerApp as u, initializeApp as v, LogLevel as w, registerVersion as x, initializeServerApp as y, getExperimentalSetting as z };
